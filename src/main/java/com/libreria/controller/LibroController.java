...
public class LibroController {
    ...
    @GetMapping("/{idLibro}")
    public ResponseEntity<LibroDto> listarLibro(@PathVariable Integer idLibro) {
    ...
    public ResponseEntity<LibroDto> actualizarLibro(@RequestBody LibroDto libroDto,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(libroService.actualizarLibro(libroDto, idLibro));
    }
